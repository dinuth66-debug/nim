// Creates floating background emojis
...
// Shows the final "Yes" page
function nextPage() {
    const container = document.getElementById('mainContainer');
    container.innerHTML = `
        <h1 style="font-size: 3rem;">I knew you'd say yes, Nimaya! 🥰</h1>
        <img id="val-photo" src="your-photo-name.jpg" alt="Our Special Moment">
